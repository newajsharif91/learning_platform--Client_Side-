      ...
      <div className="mt-20">
        <div tabIndex={0} className="collapse group mt-3">
          ...
          <div className="collapse-content bg-primary rounded-lg text-primary-content group-focus:bg-indigo-700 group-focus:text-secondary-content">
            <p>
              ORS is a node.js package for providing a Connect/Express
        ...
        <div tabIndex={0} className="collapse group mt-3">
          ...
          <div className="collapse-content bg-primary rounded-lg text-primary-content group-focus:bg-indigo-700 group-focus:text-secondary-content">
            <p>
              ...
              your onboarding flow, create funnels to see where users are
              dropping off, and use Remote Config to make changes to your app to
              see how it affects conversions. <br />
              <br />
              1. Password-based authentication· <br /> 2. Multi-factor
              authentication· <br /> 3. Certificate-based authentication· <br />{" "}
              4. Biometric authentication· br 5. Token-based authentication.
            </p>
          </div>
        </div>
        ...
        <div tabIndex={0} className="collapse group mt-3">
          ...
          <div className="collapse-content bg-primary rounded-lg text-primary-content group-focus:bg-indigo-700 group-focus:text-secondary-content">
            <p>
              ...
              component in question; otherwise, redirect the user to sign-in
              page. Additionally, we can define the logic of isLogin utility
              function separately in utils folder.
            </p>
          </div>
        </div>
