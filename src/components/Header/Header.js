...
const Header = () => {
    ...
    return (
        <div className='mt-0  bg-opacity-80 bg-orange-200 bg-clip-padding  top-0 w-full blur-filter'>
           <div className="navbar bg-base-500 ">
                ...
                <Link to='/' className="btn btn-ghost normal-case text-5xl font-bold">E-Learn</Link>
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-1 shadow bg-base-100 rounded-box w-52">
                        ...
                        <li><Link className='text-xl font-bold' to='/courses'>Course</Link></li>
                        <li><Link className='text-xl font-bold' to='/blog'>Blogs</Link></li>
                        ...
                        <>                        
                            ...
                            :
                            <span><Link className='text-xl font-bold' to='/login'>Login</Link></span>
                        }
                        </li>
