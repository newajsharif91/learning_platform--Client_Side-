          ...
          <div className=" navbar">
            ...
            <div className="dropdown dropdown-end sm:ml-34">
              ...
              >
                ...
                <li>
                  <Link className="text-xl font-bold" to="/courses">
                    Course
                  </Link>
                </li>
                <li>
                  <Link className="text-xl font-bold" to="/blog">
                    Blogs
                  </Link>
                </li>
                <li>
                  <Link className="text-xl font-bold" to="/faq">
                    FAQ
                  </Link>
                </li>
                  ...
                  {user?.uid ? (
                    <>
                      {!user.photoURL ? (
                        <>
                          {user?.displayName ? (
                            <span title={user.displayName} className="">
                              <FaUserCircle></FaUserCircle>
                            </span>
                          ) : (
                            <span title="User name not found">
                              <FaUserCircle></FaUserCircle>
                            </span>
                          )}
                        </>
                ...
                {user?.uid ? (
                  <>
                    {!user.photoURL ? (
                      <>
                        {user?.displayName ? (
                          <span title={user.displayName} className="text-2xl">
                            <FaUserCircle></FaUserCircle>
                          </span>
                        ) : (
                          <span
